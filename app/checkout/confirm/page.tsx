    ...
    <main className="relative min-h-dvh overflow-x-hidden overflow-y-auto bg-[#072116] px-4 py-5 text-[#faf6f0] sm:px-6 sm:py-8">
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100dvh-2.5rem)] w-full max-w-5xl flex-col">
        <header className="flex shrink-0 items-center justify-between gap-3">
          <Link href="/pricing" className="text-[12px] font-black uppercase tracking-[0.16em] text-[#ddb159] transition hover:text-[#f0c867]">
            ← Back to pricing
          </Link>
          <Link href="/legal" className="text-[11px] font-black uppercase tracking-[0.16em] text-[#faf6f0]/52 transition hover:text-[#ddb159]">
            Legal
          </Link>
        </header>
        ...
        <section className="grid flex-1 items-start gap-5 py-6 lg:grid-cols-[0.92fr_1.08fr] lg:items-center lg:gap-7 lg:py-8">
          <div className="min-w-0">
            ...
            <p className="mt-5 max-w-xl text-[14px] font-medium leading-7 text-[#faf6f0]/62 sm:text-[16px] sm:leading-8">
              Confirm the subscription summary, then continue to Stripe to complete payment securely.
            </p>
            ...
            <div className="relative">
              ...
              {!user ? (
                ...
                <form action="/api/create-checkout-session" method="post" className="mt-5">
                  ...
                  <button type="submit" className="mt-4 flex h-12 w-full items-center justify-center rounded-full bg-[#ddb159] px-6 text-[13px] font-black uppercase tracking-[0.14em] text-[#072116] shadow-[0_14px_34px_rgba(221,177,89,0.22)] transition hover:brightness-110">
                    Continue to Stripe
                  </button>
