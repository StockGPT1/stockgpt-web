...
export default function LoginPage() {
  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#0F2A1F] px-4 py-8 text-[#faf6f0] sm:px-6">
      ...
      <section className="relative w-full max-w-md rounded-[2rem] border border-[#ddb159]/28 bg-[#082519]/82 p-5 text-[#faf6f0] shadow-[0_24px_80px_rgba(0,0,0,0.45)] backdrop-blur-xl sm:p-8">
        ...
        <div className="mt-6 space-y-3">
          ...
          <div className="grid gap-2 pt-2 text-center text-[13px] font-semibold text-[#faf6f0]/65">
