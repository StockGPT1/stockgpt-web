    ...
    <AppShell activePath="/">
      <main className="grid h-full min-h-0 grid-rows-[auto_minmax(0,1fr)] gap-3 overflow-y-auto pr-1 lg:overflow-hidden">
        ...
        <div className="grid min-h-0 gap-3 lg:grid-cols-[minmax(0,1fr)_320px] lg:overflow-hidden">
          {/* LEFT COLUMN */}
          <section className="grid min-h-0 gap-3 lg:grid-rows-[auto_minmax(0,1fr)] lg:overflow-hidden">
            {/* S&P 500 Chart */}
            <div className="rounded-2xl border border-[#ddb159]/20 bg-[#faf6f0]/[0.03] p-4 backdrop-blur">
              <div className="flex items-baseline justify-between gap-2">
                <div>
                  ...
                  <h2 className="mt-0.5 text-[16px] font-black tracking-[-0.02em] text-[#faf6f0]">
                    S&amp;P 500
                  </h2>
                </div>
              </div>
            ...
            <div className="min-h-0 overflow-hidden rounded-2xl bg-[#faf6f0] p-3 text-[#072116] shadow-[0_14px_36px_rgba(0,0,0,0.18)]">
              <div className="mb-2 flex items-start justify-between">
                <div>
                  <h2 className="text-[18px] font-black leading-none tracking-[-0.03em]">
                    Top 10 Ranked Stocks
                  </h2>
                  <p className="mt-1 text-[10px] font-semibold text-[#072116]/55">
                ...
                {rankings.length > 0 ? (
                  rankings.map((stock) => (
                    <Link
                      ...
                      style={{ color: "#072116" }}
                      className={`grid ${gridCols} items-center border-b border-[#072116]/8 text-[11px] transition last:border-b-0 hover:bg-[#ddb159]/8`}
                    >
          ...
          <aside className="grid min-h-0 gap-3 lg:overflow-y-auto lg:pr-1">
            {/* Stat cards (compact) */}
            <div className="grid grid-cols-2 gap-2">
              ...
              <StatBlock label="Total Stocks" main="500" sub="ranked daily" />
              <StatBlock label="Last Updated" main={formatUpdatedTime(topRanked?.updated_at)} sub="latest refresh" />
            </div>
            ...
            <Link
              href="/portfolio"
              className="group relative overflow-hidden rounded-2xl border border-[#ddb159]/30 bg-[linear-gradient(135deg,#0d3420,#082519)] p-3 transition hover:border-[#ddb159]"
            >
              ...
              <div className="relative">
                ...
                <h2 className="mt-1 text-[15px] font-black tracking-[-0.02em] text-[#faf6f0]">Build a Portfolio</h2>
                <p className="mt-1 text-[10px] font-medium text-[#faf6f0]/60">
                  AI portfolio in 30 seconds with alerts and triggers.
                </p>
