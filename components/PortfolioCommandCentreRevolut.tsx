...
function PortfolioChartHero({ portfolioId, portfolios, portfolioName, currency, summary, chartData, createdAt, cashBalance }: { portfolioId: string; portfolios: PortfolioOption[]; portfolioName: string; currency: string; summary: ReturnType<typeof buildPortfolioHealthSummary>; chartData: Partial<Record<TimeRange, ChartPoint[]>>; createdAt?: string | null; cashBalance: number }) {
  const router = useRouter();
...
export function PortfolioCommandCentreRevolut({ portfolioId, portfolios, holdings, stockOptions = [], transactions = [], chartData = {}, portfolioMeta, compactImportWidget }: Props) {
