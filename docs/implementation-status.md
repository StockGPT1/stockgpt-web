...
- The new forward migrations apply on a clean LOCAL seeded reset. The 37-public-table/RLS contract, Vault hostile-session tests, Wave 1 owner/identity regressions, fake-provider endpoint/rollback/concurrency/replay tests, migration safety/negative checks, generated-type drift, complete Stage 05 acceptance, Portfolio/Stage 04 regression, Next type generation, TypeScript, tracked-source lint and guarded build pass without production/provider calls. Stage 11 customer connection UX, Stage 12 onboarding and Stage 13 projection remain NOT STARTED.
