...
- Direct authenticated financial-table privileges required by Trading 212 CSV creation/import deliberately remain until 05G/05I; no CSV replacement, legacy currency conversion, global privilege retirement or cache reconciliation semantics were pulled forward.
- Stage 05G Trading 212 import/replacement is the next slice. Full currency reconciliation, direct-write retirement and cache work remain in their approved 05H–05J slices.
