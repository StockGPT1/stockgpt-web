...
`          <div className="rounded-2xl border border-[#ddb159]/20 bg-[#ddb159]/10 p-3">
            ...
            {trimRecommendation.pct !== null && (
              <>
                <p className="mt-2 text-[11px] font-semibold leading-5 text-[#072116]/58">Approx: {trimRecommendation.estimatedValue?.toLocaleString(undefined, { maximumFractionDigits: 0 }) ?? "—"} value · {trimRecommendation.estimatedShares?.toFixed(4) ?? "—"} shares.</p>
