...
assert.match(pageChart, /allowCurrentPoint/);
assert.match(pageChart, /buildPortfolioChartInputFingerprint/);
...
assert.match(actions, /createTrading212PortfolioAtomically/);
assert.match(actions, /replacePortfolioHoldingsFromTrading212Atomically/);
assert.doesNotMatch(actions, /\.from\(["']portfolio_transactions["']\)/);
assert.doesNotMatch(actions, /invalidatePortfolioPageSnapshot|saveLatestPortfolioSnapshotFromChartData/);
